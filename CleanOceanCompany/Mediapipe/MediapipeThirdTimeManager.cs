...
{
    public static MediapipeThirdTimeManager instance;
    ...
    public Interaction_MediapipeThird interaction_MediapipeThird;
    ...
    void Update()
    {
        ...
        else if (currentTime < 0)
        {
            ...
            interaction_MediapipeThird.UpdateResultUI("실패");
            //UpdateResultUI("실패");
